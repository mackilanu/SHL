...
echo DOCTYPEN . '<title>Återbud</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/aterbud.js"></script>';
...
function read_Seasons(){
    ...
    $message_data = "SHL-ERROR vid aterbud.php function read_Seasons().";
...
function read_users(){
    ...
    $message_data = "SHL-ERROR vid aterbud.php function read_users.";
