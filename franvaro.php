...
echo DOCTYPEN . '<title>Ledighet</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/franvaro.js"></script>';
...
function read_Seasons(){
    ...
    $message_data = "SHL-ERROR vid franvaro.php function read_Seasons().";
...
function read_users(){
    ...
    $message_data = "SHL-ERROR vid franvaro.php function read_users.";
