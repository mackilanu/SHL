...
echo DOCTYPEN . '<title>Domarcoachtillsättning</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/coachtillsattning.js"></script>';
...
function read_domare(){
    ...
    $Domarlista         .= ']}';
    write_error("Domarlista=$Domarlista");
