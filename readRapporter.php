...
echo DOCTYPEN . '<title>Läs coachrapporter</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/readRapporter.js"></script>';
...
function read_Seasons(){
    ...
    $message_data = "SHL-ERROR vid readRapporter.php function read_Seasons().";
...
function read_users(){
    ...
    $message_data = "SHL-ERROR vid readRapporter.php function read_users.";

    $SQL  = "CALL read_domarNames()";
