...
echo DOCTYPEN . '<title>Användarinloggningar</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/usertraffic.js"></script>';
...
function read_users(){
    ...
    $message_data = "SHL-ERROR vid usertraffic.php function read_users.";

    $SQL  = "CALL read_UserTrafficNames()";
