...
echo DOCTYPEN . '<title>Lägg till konto</title>' . RESTEN;
...
echo '<script type="text/javascript" src="javascript/adduser.js"></script>';
...
function read_users(){
    ...
    $message_data = "SHL-ERROR vid adduser.php function read_users.";
